...
# -*- coding: utf-8 -*-
#
# ipyneural documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipyneural', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipyneuraldoc'
...
latex_documents = [
    (master_doc, 'ipyneural.tex', 'ipyneural Documentation',
     'Chung-Heng Yeh, Tingkai Liu', 'manual'),
]
